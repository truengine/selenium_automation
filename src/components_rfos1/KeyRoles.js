...
export class KeyRolesEntry extends React.Component{
  ...
  state = { key_roles:'', role_months:'', role_years:''}
  ...
  render(){
      const {key_roles, role_months, role_years} = this.state
    return(
    <div>
    <div>
    <Form.Group>
      <Form.Field>
        <Form.Input placeholder='Test Analyst' label='Role' name='key_roles' value={key_roles} onChange={this.handleChange} onBlur={this.updateForm}/>
      </Form.Field>
      <Form.Field>
        <label>Months</label>
