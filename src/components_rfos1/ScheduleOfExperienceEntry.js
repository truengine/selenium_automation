...
export class ScheduleOfExperienceEntry extends React.Component{
  ...
  render(){
    const {role_name, summary, company, start_month, end_month, start_year, end_year, exp_key, current} = this.state
    var tempkey = this.props.expKey
    return(
      <div>
        ...
        <Form.Group>
          <Form.Field>
            <label>Company</label>
            <Form.Input placeholder='Company Name' name='company' value={company} onChange={this.handler} onBlur={this.updateForm}/>
          </Form.Field>
          <Form.Field>
            <label>Role</label>
            <Form.Input placeholder='Role' name='role_name' value={role_name} onChange={this.handler} onBlur={this.updateForm}/>
          </Form.Field>
        </Form.Group>
        <Form.Group>
          <Form.Field>
          <label>Start Month</label>
            <Dropdown placeholder='mm' name='start_month' value={start_month} compact selection options={months} width={1} onChange={this.handler} onBlur={this.updateForm}/>
          </Form.Field>
          <Form.Field>
            <label>Start Year</label>
            <Dropdown placeholder='yyyy' name='start_year' value={start_year} compact selection options={years} width={1} onChange={this.handler} onBlur={this.updateForm}/>
          </Form.Field>
          <Form.Field>
        ...
        <Form.Group>
          <Form.Field>
            <label>Start Month</label>
            <Dropdown placeholder='mm' name='end_month' value={end_month} compact selection options={months} width={1} onChange={this.handler} onBlur={this.updateForm} disabled={current}/>
          </Form.Field>
          <Form.Field>
            <label>Start Year</label>
            <Dropdown placeholder='yyyy' name='end_year' value={end_year} compact selection options={years} width={1} onChange={this.handler} onBlur={this.updateForm} disabled={current}/>
          </Form.Field>
        </Form.Group>
        <Form.TextArea label='Responsibilities' placeholder='List responsibilities...'  name='summary' value={summary} onChange={this.handler} onBlur={this.updateForm}/>
